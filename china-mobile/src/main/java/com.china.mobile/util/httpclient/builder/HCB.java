package com.china.mobile.util.httpclient.builder;

import com.china.mobile.util.httpclient.common.SSLs;
...
//				.register("post", PlainConnectionSocketFactory.INSTANCE)
...
//		this.isNewSSL=true;
    ...
    public HCB proxy(String hostOrIP, int port) {
        // 依次是代理地址，代理端口号，协议类型
        HttpHost proxy = new HttpHost(hostOrIP, port, "post");
